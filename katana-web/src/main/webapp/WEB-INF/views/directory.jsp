...
<head>
  ...
  <script type="text/javascript" src="<spring:url value='/directory/directory.nocache.js'/>"></script>
  <script type="text/javascript">
    var directoryDictionary = {"contextPath": "<spring:url value='/'/>"};
  </script>
</head>
<body>
  <div id="header">
